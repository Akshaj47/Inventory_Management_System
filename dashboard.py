...
class IMS:
  def __init__(self,root):
    self.root = root
    self.root.geometry("1527x800+0+0")
    ...
    #===btn_logout===
    btn_logout=Button(self.root,text="Logout",font=("times new roman",15,"bold"),bg="yellow",cursor="hand2").place(x=1200,y=10,height=50,width=150)
    ...
    #===footer=====
    lbl_footer=Label(self.root,text="IMS-Inventory Management System | Developed By WebCode\nFor any Technical Issue Contact: 987xxxx01", font=("times new roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
